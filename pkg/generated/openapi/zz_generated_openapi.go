...
func schema_pkg_apis_scccattleio_v1_Registration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/rancher/scc-operator/pkg/apis/scc.cattle.io/v1.RegistrationSpec", "github.com/rancher/scc-operator/pkg/apis/scc.cattle.io/v1.RegistrationStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_scccattleio_v1_RegistrationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/rancher/scc-operator/pkg/apis/scc.cattle.io/v1.Registration", v1.ListMeta{}.OpenAPIModelName()},
	}
}
